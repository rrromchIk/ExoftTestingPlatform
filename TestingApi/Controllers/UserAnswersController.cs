...
public class UserAnswersController : ControllerBase
{
    ...
    public async Task<IActionResult> CreateUserAnswer([FromBody] UserAnswerDto userAnswerDto, CancellationToken cancellationToken)
    {
    ...
    [HttpPost("{userId:guid}/questions/{questionId:guid}/answers")]
    [ProducesResponseType(StatusCodes.Status201Created)]
    [ProducesResponseType(StatusCodes.Status404NotFound)]
